...
def processar_resposta(resposta):
  ...
  if resposta == '1':
        print ('No nosso site de sáude você pode acompanhar todas as noticias do por você e de todo o calendario de saúde, além disso pode se inscrever no nosso programa de acompanhamento nutricional\nLink do site')
  elif resposta == '2': 
...
#matricula do funcionário substituia o nome 
  ...
  while True:
      ...
      resposta = input (f'\nObrigada, agorara é só escolher uma das opções abaixo\nLembrando que para encerrar o seu atendimento é só nos mandar a palavrada:Sair\n1- Site de saúde;\n2- Informações de contato é Corona;\n3- Ramal Ambulatório\n')
